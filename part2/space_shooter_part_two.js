/** PART TWO - Create the player controlled ship and it's properties (move and shoot)**/
...
//load das imagens todas do jogo????

	// Ensure all images have loaded before starting the game
	var numImages = 3; //num total imagens??
	var numLoaded = 0;
 ...
 */
 ...
 //object pool. reutilizaçao dos tiros do jogador
 
function Pool(maxSize) {
	var size = maxSize; // numero máximo de tiros
	var pool = [];
	...
	this.get = function(x, y, speed) {
		if(!pool[size - 1].alive) {
			...
			pool.unshift(pool.pop()); // método unshift adiciona novos itens no inicio do array
 ...
 */
 ...
 //actualização o objecto game e funçao animaçao
function Game() {
	/*
